...
const references = [
    ...
    },
    {
        href: '/code-examples',
        name: 'Code Examples',
        description: 'Discover code snippets in different programming languages to help you get started.',
    },
    {
        href: '/additional-resources',
        name: 'Additional Resources',
        description: 'Find links to the landing page, dashboard, contact page, and more.',
    },
]
