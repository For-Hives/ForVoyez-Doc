...
const variantStyles = {
  primary:
    'rounded-full bg-slate-900 py-1 px-3 text-white hover:bg-slate-700 dark:bg-emerald-400/10 dark:text-emerald-400 dark:ring-1 dark:ring-inset dark:ring-emerald-400/20 dark:hover:bg-emerald-400/10 dark:hover:text-emerald-300 dark:hover:ring-emerald-300',
  secondary:
  ...
  filled:
    'rounded-full bg-slate-900 py-1 px-3 text-white hover:bg-slate-700 dark:bg-emerald-500 dark:text-white dark:hover:bg-emerald-400',
  outline:
