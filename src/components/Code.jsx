  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-forvoyez-orange-400/10 ring-1 ring-inset ring-forvoyez-orange-400/20'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-forvoyez-orange-400 transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
            ...
            <Tab
              className={clsx(
                ...
                childIndex === selectedIndex
                  ? 'border-forvoyez-orange-500 text-forvoyez-orange-400'
