...
function SearchResult({
	...
	return (
		<li
			className={clsx(
				'group block cursor-default px-4 py-3 aria-selected:bg-slate-50',
				resultIndex > 0 && 'border-t border-slate-100'
			)}
		...
		>
			<div
				id={`${id}-title`}
				aria-hidden="true"
				className="text-sm font-medium text-slate-900 group-aria-selected:text-forvoyez_orange-500"
			>
		...
		<div className="group relative flex h-12">
			...
			{autocompleteState.status === 'stalled' && (
				<div className="absolute inset-y-0 right-3 flex items-center">
					<LoadingIcon className="h-5 w-5 animate-spin stroke-slate-200 text-slate-900" />
				</div>
			)}
		</div>
	)
		...
		>
			...
			>
				...
				<div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
					...
					>
						<Dialog.Panel className="mx-auto transform-gpu overflow-hidden rounded-lg bg-slate-50 shadow-xl ring-1 ring-slate-900/7.5 sm:max-w-xl">
							<div {...autocomplete.getRootProps({})}>
								...
								>
									...
									<div
										ref={panelRef}
										className="border-t border-slate-200 bg-white empty:hidden"
	...
	return (
		<div className="hidden lg:block lg:max-w-md lg:flex-auto">
			...
			>
				...
				Find something...
				<kbd className="ml-auto text-2xs text-slate-400">
	...
	return (
		<div className="contents lg:hidden">
			<button
				...
				{...buttonProps}
			>
				<SearchIcon className="h-5 w-5 stroke-slate-900" />
			</button>
			<Suspense fallback={null}>
