...
- `data`: A JSON object that includes:
...
- `language`: A string specifying the desired language for the metadata output (optional, defaults to 'en' for English).

The API will process your request and return a JSON response containing the generated alt text and other metadata based on your specified schema and language.
