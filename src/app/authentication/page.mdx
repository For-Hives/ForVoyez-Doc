...
export const metadata = {
	...
	description:
		'Learn how to authenticate your requests to the ForVoyez API and follow security best practices.',
}
...
<div className="not-prose">
	<Button href="https://forvoyez.com/app/tokens" variant="text" arrow="right">
