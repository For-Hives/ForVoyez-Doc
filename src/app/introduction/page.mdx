export const metadata = {
    title: 'Introduction',
    description: 'Discover our AI-powered API for automatic generation of alt text and metadata for images. Boost your SEO and improve accessibility with ease.',
}
