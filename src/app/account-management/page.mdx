...
export const metadata = {
    ...
    description: 'Learn how to manage your ForVoyez API account, including user settings, subscriptions, and billing.',
}
...
<div className="not-prose">
    <Button href="https://forvoyez.com/app/user-account" variant="text" arrow="right">
...
<div className="not-prose">
    <Button href="https://forvoyez.com/app/plan" variant="text" arrow="right">
        Manage Subscription
    </Button>
</div>
