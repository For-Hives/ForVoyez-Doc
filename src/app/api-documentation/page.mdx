...
- `GET /usage`: Retrieve usage statistics for your account.
- `GET /plans`: Get a list of available subscription plans.
...
The error response body will include an `error` object with more details:
