...
Note the addition of the `language` parameter in the cURL request. This parameter allows you to specify the desired language for the generated metadata.
...
- Implement the `language` parameter in your requests to get metadata in your desired language.
