...
export const metadata = {
    ...
    description: 'Track your ForVoyez API usage statistics, monitor quotas and limits, and receive alerts and notifications.',
}
...
<div className="not-prose">
    <Button href="https://forvoyez.com/app/usage#quota" variant="text" arrow="right">
...
<div className="not-prose">
    <Button href="https://forvoyez.com/app/usage#alerts" variant="text" arrow="right">
