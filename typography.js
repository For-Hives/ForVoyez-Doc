  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links': theme('colors.forvoyez-orange.500'),
        '--tw-prose-links-hover': theme('colors.forvoyez-orange.600'),
        '--tw-prose-links-underline': theme('colors.forvoyez-orange.500 / 0.3'),
        ...
        '--tw-prose-invert-links': theme('colors.forvoyez-orange.400'),
        '--tw-prose-invert-links-hover': theme('colors.forvoyez-orange.500'),
        '--tw-prose-invert-links-underline': theme('colors.forvoyez-orange.500 / 0.3'),
