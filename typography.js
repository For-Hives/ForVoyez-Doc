  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links': theme('colors.forvoyez_orange.500'),
        '--tw-prose-links-hover': theme('colors.forvoyez_orange.600'),
        '--tw-prose-links-underline': theme('colors.forvoyez_orange.500 / 0.3'),
        ...
        '--tw-prose-invert-links': theme('colors.forvoyez_orange.400'),
        '--tw-prose-invert-links-hover': theme('colors.forvoyez_orange.500'),
        '--tw-prose-invert-links-underline': theme('colors.forvoyez_orange.500 / 0.3'),
